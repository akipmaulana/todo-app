                    ...
                    <Body>
                        ...
                        <Text style={Style.project_name_text}>{ this.props.data.item.name }</Text>
                        {
                            this.props.data.item.isClosed ?
                                <ButtonOpen loading={this.state.closeLoading} onPress={this.handlePress.bind(this)} /> :
                                <ButtonClose loading={this.state.closeLoading} onPress={this.handlePress.bind(this)} />
                        }
                    </Body>
                </CardItem>
            </Card>
